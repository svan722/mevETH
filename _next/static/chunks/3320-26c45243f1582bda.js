  ...
  [3320, 4525],
  {
    70855: function (e, t, n) {
      var i = n(85893),
        ...
        r = n(74509),
        d = n(51192);
      let c = (0, d.ZP)(r.E.div).withConfig({ componentId: "sc-d8f5bd38-0" })`
  display: flex;
  flex-direction: row;
...
`;
      t.Z = function () {
        return (0, i.jsx)(a.NL.Custom, {
          children: (e) => {
            let { mounted: t, account: n, openAccountModal: o } = e;
            return (0, i.jsx)(s.M, {
              children:
                n &&
                t &&
                    ...
                    children: [
                      ...
                      (0, i.jsxs)(p, {
                        children: [
                          ...
                          n
                            ? n.ensName ||
                              `${n.address.slice(0, 6)}...${n.address.slice(
                                n.address.length - 3,
                                n.address.length
                              )}`
                            : null,
    ...
    90374: function (e, t, n) {
      var i = n(85893),
        o = n(51192);
      let a = o.ZP.div.withConfig({ componentId: "sc-547afdda-0" })``;
      t.Z = function () {
        return (0, i.jsx)(a, {});
      };
    },
    89230: function (e, t, n) {
      var i = n(85893),
        ...
        p = n(72033),
        x = n(62331);
      let h = c.ZP.a.withConfig({ componentId: "sc-fadb2cbd-0" })`
  color: #fff;
  margin-right: 20px;
  margin-left: 40px;
`,
...
`;
      t.Z = function () {
        let [e, t] = (0, d.useState)(!0),
          ...
          [b, w] = (0, d.useState)(0n),
          { address: v } = (0, f.mA)(),
          [j, y] = (0, r.KO)(a.mevETHBalance),
          [C, E] = (0, r.KO)(a.depositedETHBalance),
          [S, Z] = (0, d.useState)(0xe172a7bc98947f5n),
          [k, F] = (0, d.useState)(0n),
          { data: I, error: T } = (0, f.do)({
            address: o.W7,
            abi: p.yS,
        ...
        return (
          ...
          (0, d.useEffect)(() => {
            if (P) {
              console.log("userMevETHBalance 111", I),
                console.log("userConvertToAssets 111", P);
              let e = P - 0xde0b6b3a7640000n;
              I && (e = P - I),
                s(e),
                console.log("assets", P),
                m(I || 0xde0b6b3a7640000n),
                y(
                  I
                    ? parseFloat((0, l.d)(I))
                        .toFixed(3)
    ...
    35854: function (e, t, n) {
      ...
      var i = n(43120),
        o = n(51192);
      let a = o.ZP.div.withConfig({ componentId: "sc-11156ab2-0" })`
  background: #212738;
  width: 100%;
  height: 52px;
...
`,
  ...
  ${(e) =>
    e.onClick && !e.disabled && "&:hover { cursor: pointer; color: #ffffff; }"}
...
`;
    ...
    34525: function (e, t, n) {
      ...
      function b(e) {
        ...
        return a
          ? (0, i.jsx)(j, { onClick: a, children: n })
          : r
          ? (0, i.jsx)(l(), {
              target: o,
              href: t,
              title: d,
              children: (0, i.jsx)(E, { color: s, children: n }),
            })
          : c
          ? (0, i.jsx)(l(), {
              target: o,
              ...
              children: (0, i.jsxs)("span", {
                children: [
                  (0, i.jsx)("span", { style: { color: s }, children: n }),
                  (0, i.jsx)(w, { children: "NEW" }),
                ],
              }),
            })
          : (0, i.jsx)(l(), {
              ...
              color: s,
              title: d,
              children: (0, i.jsx)(j, { color: s, children: n }),
            });
      }
      let w = p.ZP.span.withConfig({ componentId: "sc-27d96e2-0" })`
  background: #185c64;
  margin-left: 5px;
  padding: 2px 4px;
  border-radius: 5px;
...
`,
  ...
  height: 100%;
`,
        Z = (0, p.ZP)(S).withConfig({ componentId: "sc-27d96e2-6" })``;
      t.default = function () {
          ...
          (0, f.useEffect)(() => {
            if (A) {
              console.log("userMevETHBalance 111", M),
                console.log("userConvertToAssets 111", A);
              let e = A - 0xde0b6b3a7640000n;
              M && (e = A - M),
                c(e),
                console.log("assets", A),
                p(M || 0xde0b6b3a7640000n),
                F(
                  M
                    ? parseFloat((0, x.d)(M))
                        .toFixed(3)
              ...
              n
                ? (0, i.jsxs)(s.fC, {
                    children: [
                      (0, i.jsx)(s.xz, {
                        asChild: !0,
                        children: (0, i.jsx)(j, { children: " Explore " }),
                      }),
                      (0, i.jsxs)(C, {
                        avoidCollisions: !0,
                        sideOffset: 13,
                ...
                : (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)(b, { href: "/stake", text: "mevETH" }),
                      (0, i.jsx)(b, {
                        href: "/redemptions",
                        text: "Redemptions",
                      }),
